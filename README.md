...
🧠  I'm Backend Developer using:
  - NodeJs - JavaScript - TypeScript - C# - ExpressJs - Fastify - Prisma
  - TypeORM - NestJs - Jest - Git - Zod - MySql - Postgres - API - REST
  - supertest - vitest - Docker - e2e - unit test - clean architecture
